...
namespace AnyPortrait
{
	...
	/// <summary>
	/// Class for enemies attacking players
	/// </summary>
	public class apTutorial_PirateGame_Enemy : MonoBehaviour
	{
		// Members
		//---------------------------------------------
		...
		public void Spawn(Vector3 position, int spawnOrder)
		{
			...
			{
				//땅으로 나와서 스폰해야한다.
				RaycastHit2D hitResult = Physics2D.Raycast(position + new Vector3(0, 10, 0), new Vector2(0, -1), 100);
				...
				case STATUS_MOVE:
					{
						...
						else
						{
							...
							RaycastHit2D hitResult = Physics2D.Raycast(curPos + new Vector3(0.0f, 20.0f, 0.0f), new Vector2(0, -1), 50);
							if (hitResult && hitResult.collider != null)
							{
