...
namespace AnyPortrait
{
	...
	/// <summary>
	/// Class for the bullet that the player fires
	/// </summary>
	public class apTutorial_PirateGame_Bullet : MonoBehaviour
	{
		// Members
		//---------------------------------------------------------
		...
		public void Shoot(Vector3 startPos, Vector3 direction)
		{
			...
			RaycastHit2D hitResult = Physics2D.Raycast(_startPos, direction, 100.0f);
